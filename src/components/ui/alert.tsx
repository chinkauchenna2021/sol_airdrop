  ...
  'relative w-full rounded-lg border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7',
  {
    variants: {
      variant: {
        ...
        warning: 'bg-yellow-500/10 border-yellow-500/20 text-yellow-300 [&>svg]:text-yellow-400',
        success: 'bg-green-500/10 border-green-500/20 text-green-300 [&>svg]:text-green-400',
