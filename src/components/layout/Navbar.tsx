...
//                 twitterConnection={connectTwitter}
...
//                         <p className="text-white font-medium">{session?.user.twitterUsername || 'Anonymous'}</p>
//                         {isAdmin && (
...
//                         )}
//                       </div>
//                       <p className="text-sm text-gray-400">{session?.user.totalPoints?.toLocaleString() || 0} points</p>
//                     </div>
//                     <div className="flex items-center space-x-1">
//                       <Star className="w-4 h-4 text-yellow-400" />
//                       <span className="text-yellow-400 font-bold text-sm">
//                         Rank #{session?.user.rank || 0}
//                       </span>
//                     </div>
//                   </motion.div>
//                 )}
    ...
    <>
      ...
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled 
            ? 'bg-black/90 backdrop-blur-xl border-b border-purple-500/20 shadow-2xl shadow-purple-500/10' 
            : 'bg-black/90 backdrop-blur-xl' // Fixed: Always use dark background
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* FLEXIBLE LAYOUT FOR NATURAL FLOW */}
