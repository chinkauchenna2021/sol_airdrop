...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { href: '/admin/nft-minting', label: 'NFT Minting', icon: Palette },
            ...
            {menuItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-200"
                >
