  ...
  const features = [
    {
      ...
      description:
        "Seamlessly connect your Solana wallet to start earning rewards instantly",
    ...
    },
    {
      ...
      description:
        "Connect your Twitter account to track engagements and maximize earnings",
    ...
    },
    {
      ...
      title: "Earn & Compete",
      description:
        "Complete tasks, engage with content, and climb the global leaderboard",
    ...
    },
    {
      ...
      title: "Claim Rewards",
      description:
        "Convert your points to tokens and receive instant payouts to your wallet",
  ...
  const testimonials = [
    {
      ...
      content:
        "SolDrop has completely changed how I engage with crypto communities. The rewards are real!",
      rating: 5,
    },
    {
      ...
      content:
        "Amazing platform! I've earned over $500 just by being active on Twitter and completing simple tasks.",
      rating: 5,
    },
    {
      name: "David Kim",
      ...
      content:
        "The tokenomics are brilliant and the community is incredibly supportive. Highly recommended!",
      rating: 5,
    },
  ];
  const roadmapItems = [
    {
      ...
      description:
        "Core features, wallet integration, and initial token distribution",
      status: "completed",
    },
    {
      quarter: " 2025",
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              The ultimate $Connect Solana Airdrop where your social media
              engagement translates to real cryptocurrency rewards. Join
          ...
          >
            {[
              ...
              return (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${stat.color} opacity-0 group-hover:opacity-10 transition-opacity rounded-2xl`}
                  />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Start earning $Connect rewards in four simple steps. No complex
              setups, no hidden fees.
            </p>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                  />
                  <div className="relative p-8 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-white/20 transition-all duration-300 h-full">
                    <div className="flex items-center justify-center mb-6">
                      <div
                        className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center relative`}
                      >
                        <Icon className="w-8 h-8 text-white" />
      ...
      <section className="relative py-32 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Discover what's coming next as we continue to revolutionize the
              airdrop ecosystem.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Join thousands of users already earning cryptocurrency rewards
